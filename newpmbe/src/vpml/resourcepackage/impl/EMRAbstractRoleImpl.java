...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EMR Abstract Role</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link vpml.resourcepackage.impl.EMRAbstractRoleImpl#getEmrDiagram <em>Emr Diagram</em>}</li>
 *   <li>{@link vpml.resourcepackage.impl.EMRAbstractRoleImpl#getSourceClassificationRelations <em>Source Classification Relations</em>}</li>
 *   <li>{@link vpml.resourcepackage.impl.EMRAbstractRoleImpl#getTargetClassificationRelation <em>Target Classification Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EMRAbstractRoleImpl extends EMRAbstractResourceTypeImpl implements EMRAbstractRole {
	/**
	...
	protected EClass eStaticClass() {
		return ResourcepackagePackage.Literals.EMR_ABSTRACT_ROLE;
	}
	...
	public EMRDiagram getEmrDiagram() {
		if (eContainerFeatureID != ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM) return null;
	...
	public NotificationChain basicSetEmrDiagram(EMRDiagram newEmrDiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEmrDiagram, ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEmrDiagram(EMRDiagram newEmrDiagram) {
		if (newEmrDiagram != eInternalContainer() || (eContainerFeatureID != ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM && newEmrDiagram != null)) {
			...
			if (newEmrDiagram != null)
				msgs = ((InternalEObject)newEmrDiagram).eInverseAdd(this, ResourcepackagePackage.EMR_DIAGRAM__ABSTRACT_ROLES, EMRDiagram.class, msgs);
			msgs = basicSetEmrDiagram(newEmrDiagram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM, newEmrDiagram, newEmrDiagram));
	}
	...
	public EList getSourceClassificationRelations() {
		if (sourceClassificationRelations == null) {
			sourceClassificationRelations = new EObjectWithInverseResolvingEList(EMRClassificationRelation.class, this, ResourcepackagePackage.EMR_ABSTRACT_ROLE__SOURCE_CLASSIFICATION_RELATIONS, ResourcepackagePackage.EMR_CLASSIFICATION_RELATION__SOURCE_ABS_ROLE_TYPE);
		}
		...
		if (targetClassificationRelation != null && targetClassificationRelation.eIsProxy()) {
			...
			if (targetClassificationRelation != oldTargetClassificationRelation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcepackagePackage.EMR_ABSTRACT_ROLE__TARGET_CLASSIFICATION_RELATION, oldTargetClassificationRelation, targetClassificationRelation));
			}
		}
	...
	public NotificationChain basicSetTargetClassificationRelation(EMRClassificationRelation newTargetClassificationRelation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ResourcepackagePackage.EMR_ABSTRACT_ROLE__TARGET_CLASSIFICATION_RELATION, oldTargetClassificationRelation, newTargetClassificationRelation);
	...
	public void setTargetClassificationRelation(EMRClassificationRelation newTargetClassificationRelation) {
		if (newTargetClassificationRelation != targetClassificationRelation) {
			...
			if (targetClassificationRelation != null)
				msgs = ((InternalEObject)targetClassificationRelation).eInverseRemove(this, ResourcepackagePackage.EMR_CLASSIFICATION_RELATION__TARGET_ABS_ROLE_TYPE, EMRClassificationRelation.class, msgs);
			if (newTargetClassificationRelation != null)
				msgs = ((InternalEObject)newTargetClassificationRelation).eInverseAdd(this, ResourcepackagePackage.EMR_CLASSIFICATION_RELATION__TARGET_ABS_ROLE_TYPE, EMRClassificationRelation.class, msgs);
			msgs = basicSetTargetClassificationRelation(newTargetClassificationRelation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcepackagePackage.EMR_ABSTRACT_ROLE__TARGET_CLASSIFICATION_RELATION, newTargetClassificationRelation, newTargetClassificationRelation));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEmrDiagram((EMRDiagram)otherEnd, msgs);
			case ResourcepackagePackage.EMR_ABSTRACT_ROLE__SOURCE_CLASSIFICATION_RELATIONS:
				return ((InternalEList)getSourceClassificationRelations()).basicAdd(otherEnd, msgs);
			case ResourcepackagePackage.EMR_ABSTRACT_ROLE__TARGET_CLASSIFICATION_RELATION:
				if (targetClassificationRelation != null)
					msgs = ((InternalEObject)targetClassificationRelation).eInverseRemove(this, ResourcepackagePackage.EMR_CLASSIFICATION_RELATION__TARGET_ABS_ROLE_TYPE, EMRClassificationRelation.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case ResourcepackagePackage.EMR_ABSTRACT_ROLE__EMR_DIAGRAM:
				return eInternalContainer().eInverseRemove(this, ResourcepackagePackage.EMR_DIAGRAM__ABSTRACT_ROLES, EMRDiagram.class, msgs);
		}
