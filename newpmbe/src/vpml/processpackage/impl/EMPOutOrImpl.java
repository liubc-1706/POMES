...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EMP Out Or</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link vpml.processpackage.impl.EMPOutOrImpl#getEmpDiagram <em>Emp Diagram</em>}</li>
 *   <li>{@link vpml.processpackage.impl.EMPOutOrImpl#getSourceFlows <em>Source Flows</em>}</li>
 *   <li>{@link vpml.processpackage.impl.EMPOutOrImpl#getTargetFlows <em>Target Flows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EMPOutOrImpl extends EMPOutConnectorImpl implements EMPOutOr {
	/**
	...
	protected EClass eStaticClass() {
		return ProcesspackagePackage.Literals.EMP_OUT_OR;
	}
	...
	public EMPDiagram getEmpDiagram() {
		if (eContainerFeatureID != ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM) return null;
	...
	public NotificationChain basicSetEmpDiagram(EMPDiagram newEmpDiagram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEmpDiagram, ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM, msgs);
		return msgs;
	}
	...
	public void setEmpDiagram(EMPDiagram newEmpDiagram) {
		if (newEmpDiagram != eInternalContainer() || (eContainerFeatureID != ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM && newEmpDiagram != null)) {
			...
			if (newEmpDiagram != null)
				msgs = ((InternalEObject)newEmpDiagram).eInverseAdd(this, ProcesspackagePackage.EMP_DIAGRAM__OUT_ORS, EMPDiagram.class, msgs);
			msgs = basicSetEmpDiagram(newEmpDiagram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM, newEmpDiagram, newEmpDiagram));
	}
	...
	public EList getSourceFlows() {
		if (sourceFlows == null) {
			sourceFlows = new EObjectWithInverseResolvingEList(EMPDataFlow.class, this, ProcesspackagePackage.EMP_OUT_OR__SOURCE_FLOWS, ProcesspackagePackage.EMP_DATA_FLOW__SOURCE_OUT_OR);
		}
		return sourceFlows;
	}
	...
	public EList getTargetFlows() {
		if (targetFlows == null) {
			targetFlows = new EObjectWithInverseResolvingEList(EMPDataFlow.class, this, ProcesspackagePackage.EMP_OUT_OR__TARGET_FLOWS, ProcesspackagePackage.EMP_DATA_FLOW__TARGET_OUT_OR);
		}
		return targetFlows;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetEmpDiagram((EMPDiagram)otherEnd, msgs);
			case ProcesspackagePackage.EMP_OUT_OR__SOURCE_FLOWS:
				return ((InternalEList)getSourceFlows()).basicAdd(otherEnd, msgs);
			case ProcesspackagePackage.EMP_OUT_OR__TARGET_FLOWS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case ProcesspackagePackage.EMP_OUT_OR__EMP_DIAGRAM:
				return eInternalContainer().eInverseRemove(this, ProcesspackagePackage.EMP_DIAGRAM__OUT_ORS, EMPDiagram.class, msgs);
		}
	...
	public List getTargetLogicalConnectors() {
		List targetConnList=new ArrayList<EMPOutAnd>();
		if(sourceFlows==null)
			return null;
		for(int i=0;i<sourceFlows.size();i++)
		{
			...
			if(dataFlow.getTargetOutAnd()!=null)
				targetConnList.add(dataFlow.getTargetOutAnd());
		}
