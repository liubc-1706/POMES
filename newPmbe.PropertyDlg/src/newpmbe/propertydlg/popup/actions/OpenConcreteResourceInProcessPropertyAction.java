...
import newpmbe.DlgPackage.ConcreteResourceInProcessDlg;
...
public class OpenConcreteResourceInProcessPropertyAction extends AbstractActionDelegate implements IObjectActionDelegate {
	...
	protected void doRun(IProgressMonitor progressMonitor){
		...
		ConcreteResourceInProcessDlg dlg = new ConcreteResourceInProcessDlg(shell, obj, editorFile);
