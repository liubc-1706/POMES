...
import newpmbe.DlgPackage.AbstractResourceDlg;
...
public class OpenAbstractResourcePropertyAction extends AbstractActionDelegate implements IObjectActionDelegate {
	...
	protected void doRun(IProgressMonitor progressMonitor){
		...
		AbstractResourceDlg dlg = new AbstractResourceDlg(shell, obj);
