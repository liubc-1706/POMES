 ...
 * @generated
 */
public class EMRRoleNameEditPart extends NewPMBEExtNodeLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMRRoleNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMRRoleNameEditPart(View view) {
		super(view);
	}
