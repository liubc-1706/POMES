...
import newpmbe.organization.diagram.edit.policies.EMOResourceGroupTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMOResourceGroupTypeEditPart extends ShapeNodeEditPart implements EditableOrg{
	...
	protected NodeFigure createNodePlate() {
		...
		presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMOGroupType.svg"),
				null);
		...
		final ScalableImageFigure sif = new ScalableImageFigure(rndImg, false,
				false, true);
		sif.setPreferredImageSize(50, 40);
