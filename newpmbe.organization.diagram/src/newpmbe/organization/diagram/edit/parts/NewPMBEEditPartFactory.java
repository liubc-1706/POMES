	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case EMODiagramEditPart.VISUAL_ID:
				return new EMODiagramEditPart(view);
			case EMOComposeRelationEditPart.VISUAL_ID:
				return new EMOComposeRelationEditPart(view);
			case EMOAssociationRelationEditPart.VISUAL_ID:
				return new EMOAssociationRelationEditPart(view);
			case EMOAssociationRelationNameEditPart.VISUAL_ID:
				return new EMOAssociationRelationNameEditPart(view);
			case EMOAssociationRelation2EditPart.VISUAL_ID:
				return new EMOAssociationRelation2EditPart(view);
			case EMOAssociationRelationName2EditPart.VISUAL_ID:
				return new EMOAssociationRelationName2EditPart(view);
			case EMOAssociationRelation3EditPart.VISUAL_ID:
				return new EMOAssociationRelation3EditPart(view);
			case EMOAssociationRelationName3EditPart.VISUAL_ID:
				return new EMOAssociationRelationName3EditPart(view);
			case EMOAssociationRelation4EditPart.VISUAL_ID:
				return new EMOAssociationRelation4EditPart(view);
			case EMOAssociationRelationName4EditPart.VISUAL_ID:
				return new EMOAssociationRelationName4EditPart(view);
			}
		}
