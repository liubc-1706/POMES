 ...
 * @generated
 */
public class NewPMBEStructuralFeatureParser extends NewPMBEAbstractParser {
	 ...
	 * @generated
	 */
	public NewPMBEStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(NewPMBEDiagramEditorPlugin.ID,
