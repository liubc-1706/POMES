 ...
 * @generated
 */
public class EMRRoleViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.organization.diagram.edit.parts.EMRRoleEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view,
				NewPMBEVisualIDRegistry.getType(EMRRoleNameEditPart.VISUAL_ID),
