 ...
 * @generated
 */
public class EMOAssociationRelation2ViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.organization.diagram.edit.parts.EMOAssociationRelation2EditPart.VISUAL_ID);
