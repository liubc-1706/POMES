 ...
 * @generated
 */
public class EMOAssociationRelationViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.organization.diagram.edit.parts.EMOAssociationRelationEditPart.VISUAL_ID);
