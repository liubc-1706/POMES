 ...
 * @generated
 */
public class EMOAssociationRelation3ViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.organization.diagram.edit.parts.EMOAssociationRelation3EditPart.VISUAL_ID);
