 ...
 * @generated
 */
public class EMRClassificationRelationViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.resource.diagram.edit.parts.EMRClassificationRelationEditPart.VISUAL_ID);
