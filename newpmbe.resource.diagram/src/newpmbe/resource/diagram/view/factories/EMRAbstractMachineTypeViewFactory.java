 ...
 * @generated
 */
public class EMRAbstractMachineTypeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.resource.diagram.edit.parts.EMRAbstractMachineTypeEditPart.VISUAL_ID);
