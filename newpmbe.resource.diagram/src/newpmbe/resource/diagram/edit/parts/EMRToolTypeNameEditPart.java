 ...
 * @generated
 */
public class EMRToolTypeNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMRToolTypeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMRToolTypeNameEditPart(View view) {
		super(view);
	}
