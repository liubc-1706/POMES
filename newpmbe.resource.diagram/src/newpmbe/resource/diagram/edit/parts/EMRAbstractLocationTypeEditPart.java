...
import newpmbe.resource.diagram.edit.policies.EMRAbstractLocationTypeItemSemanticEditPolicy;

import newpmbe.resource.diagram.edit.policies.NewPMBEExtNodeLabelHostLayoutEditPolicy;
 ...
 * @generated
 */
public class EMRAbstractLocationTypeEditPart extends ShapeNodeEditPart implements EditableRes {
	 ...
	 * @generated
	 */
	public EMRAbstractLocationTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRAbstractLocationTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRAbstractLocationTypeEditPart.this
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				...
				"icons/EMRAbstractLocationType.svg"), null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRAbstractLocationTypeNameEditPart) {
			return true;
		}
		return false;
	}
