...
import newpmbe.resource.diagram.edit.policies.NewPMBETextSelectionEditPolicy;
 ...
 * @generated
 */
public class EMRMachineTypeNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMRMachineTypeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMRMachineTypeNameEditPart(View view) {
		super(view);
	}
