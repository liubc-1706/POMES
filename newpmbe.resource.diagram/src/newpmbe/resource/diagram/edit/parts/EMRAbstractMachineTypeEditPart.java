...
import newpmbe.resource.diagram.edit.policies.EMRAbstractMachineTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRAbstractMachineTypeEditPart extends ShapeNodeEditPart implements EditableRes{
	 ...
	 * @generated
	 */
	public EMRAbstractMachineTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRAbstractMachineTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRAbstractMachineTypeEditPart.this
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				...
				"icons/EMRAbstractMachineType.svg"), null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRAbstractMachineTypeNameEditPart) {
			return true;
		}
		return false;
	}
