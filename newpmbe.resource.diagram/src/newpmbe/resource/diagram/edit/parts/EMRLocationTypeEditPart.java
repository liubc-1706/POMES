...
import newpmbe.resource.diagram.edit.policies.EMRLocationTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRLocationTypeEditPart extends ShapeNodeEditPart implements EditableRes{
	 ...
	 * @generated
	 */
	public EMRLocationTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRLocationTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRLocationTypeEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				...
				"icons/EMRLocationType.svg"), null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRLocationTypeNameEditPart) {
			return true;
		}
		return false;
	}
