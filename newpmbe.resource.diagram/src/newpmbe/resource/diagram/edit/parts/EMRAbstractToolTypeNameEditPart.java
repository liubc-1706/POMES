 ...
 * @generated
 */
public class EMRAbstractToolTypeNameEditPart extends
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMRAbstractToolTypeNameEditPart.VISUAL_ID), new Point(
				0, 0));
	}
	 ...
	 * @generated
	 */
	public EMRAbstractToolTypeNameEditPart(View view) {
		super(view);
	}
