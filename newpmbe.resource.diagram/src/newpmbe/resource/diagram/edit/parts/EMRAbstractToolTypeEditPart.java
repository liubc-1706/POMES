...
import newpmbe.resource.diagram.edit.policies.EMRAbstractToolTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRAbstractToolTypeEditPart extends ShapeNodeEditPart implements EditableRes{
	 ...
	 * @generated
	 */
	public EMRAbstractToolTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRAbstractToolTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRAbstractToolTypeEditPart.this
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				...
				"icons/EMRAbstractToolType.svg"), null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRAbstractToolTypeNameEditPart) {
			return true;
		}
		return false;
	}
