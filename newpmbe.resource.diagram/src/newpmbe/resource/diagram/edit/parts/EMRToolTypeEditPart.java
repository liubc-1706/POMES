...
import newpmbe.resource.diagram.edit.policies.EMRToolTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRToolTypeEditPart extends ShapeNodeEditPart implements EditableRes{
	 ...
	 * @generated
	 */
	public EMRToolTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRToolTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRToolTypeEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMRToolType.svg"),
				null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRToolTypeNameEditPart) {
			return true;
		}
		return false;
	}
