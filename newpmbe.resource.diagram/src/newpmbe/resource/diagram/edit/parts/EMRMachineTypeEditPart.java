...
import newpmbe.resource.diagram.edit.policies.EMRMachineTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRMachineTypeEditPart extends ShapeNodeEditPart implements EditableRes{
	 ...
	 * @generated
	 */
	public EMRMachineTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMRMachineTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMRMachineTypeEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				...
				new Path("icons/EMRMachineType.svg"), null);
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMRMachineTypeNameEditPart) {
			return true;
		}
		return false;
	}
