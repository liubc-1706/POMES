    ...
    public void handleEvent(SVNEvent event, double progress) {
        ...
        if (action == SVNEventAction.UPDATE_ADD) {
            ...
            if (contentsStatus == SVNStatusType.CHANGED) {
                /*
                 * the  item  was  modified in the org.tmatesoft.svn.examples.repository (got  the changes 
                 * from the org.tmatesoft.svn.examples.repository
                 */
                pathChangeType = "U";
            }else if (contentsStatus == SVNStatusType.CONFLICTED) {
                /*
                 * The file item is in  a  state  of Conflict. That is, changes
                 * received from the org.tmatesoft.svn.examples.repository during an update, overlap  with 
                 ...
                 * org.tmatesoft.svn.examples.repository  did  not  overlap local changes and were  merged 
                 * into the file).
                 */
                pathChangeType = "G";
            }
        ...
        if (propertiesStatus == SVNStatusType.CHANGED) {
            ...
            /*
             * Properties that came from the org.tmatesoft.svn.examples.repository were  merged  with  the
             * local ones.
             */
