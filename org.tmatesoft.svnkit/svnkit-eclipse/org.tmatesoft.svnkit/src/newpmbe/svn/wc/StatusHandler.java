...
public class StatusHandler implements ISVNStatusHandler, ISVNEventHandler {
    ...
    public void handleStatus(SVNStatus status) {
        ...
        if (contentsStatus == SVNStatusType.STATUS_MODIFIED) {
             ...
             * Deletion from the org.tmatesoft.svn.examples.repository.
             */
            pathChangeType = "D";
        } else if (contentsStatus == SVNStatusType.STATUS_ADDED) {
            /*
             * The file, directory or symbolic link item has been scheduled for 
             * Addition to the org.tmatesoft.svn.examples.repository.
             */
            pathChangeType = "A";
            ...
            /*
             * The file, directory or symbolic link item is in  the  org.tmatesoft.svn.examples.repository 
             ...
             * file in the org.tmatesoft.svn.examples.repository,  but  the  user  removed  the  file  and 
             ...
             * While they may have the same name, the org.tmatesoft.svn.examples.repository considers them 
         ...
         * in the org.tmatesoft.svn.examples.repository   
         */
        ...
        if (propertiesStatus == SVNStatusType.STATUS_MODIFIED) {
            ...
            /*
             * Properties are in conflict with the org.tmatesoft.svn.examples.repository.
             */
        ...
        if (localLock != null) {
            ...
            if (remoteLock != null) {
                ...
                if(myIsRemote){
	                 ...
	                 * org.tmatesoft.svn.examples.repository - the lock was Broken. This  is  true only if 
            ...
            /*
             * the file is not locally locked but locked  in  the  org.tmatesoft.svn.examples.repository -
