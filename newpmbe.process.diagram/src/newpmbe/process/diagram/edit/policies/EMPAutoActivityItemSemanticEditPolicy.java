 ...
 * @generated
 */
public class EMPAutoActivityItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (NewPMBEElementTypes.EMPAssFlow_4010 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4010Command(req);
		}
		if (NewPMBEElementTypes.EMPAssFlow_4012 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4012Command(req);
		}
		if (NewPMBEElementTypes.EMPAssFlow_4025 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4025Command(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4010Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4010Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4010Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4010Command(CreateRelationshipRequest req) {
			super(req);
		}
		...
		protected EObject doDefaultElementCreation() {
			EMPAssFlow newElement = (EMPAssFlow) super
					.doDefaultElementCreation();
			if (newElement != null) {
				newElement.setAutoActivity((EMPAutoActivity) getTarget());
				newElement
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4012Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4012Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4012Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4012Command(CreateRelationshipRequest req) {
			super(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4025Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4025Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4025Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4025Command(CreateRelationshipRequest req) {
			super(req);
		}
