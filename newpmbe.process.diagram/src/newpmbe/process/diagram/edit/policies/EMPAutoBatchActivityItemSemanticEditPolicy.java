 ...
 * @generated
 */
public class EMPAutoBatchActivityItemSemanticEditPolicy extends
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (NewPMBEElementTypes.EMPAssFlow_4009 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4009Command(req);
		}
		if (NewPMBEElementTypes.EMPAssFlow_4013 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4013Command(req);
		}
		if (NewPMBEElementTypes.EMPAssFlow_4026 == req.getElementType()) {
			return req.getTarget() == null ? null
					: getCreateCompleteIncomingEMPAssFlow4026Command(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4009Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4009Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4009Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4009Command(CreateRelationshipRequest req) {
			super(req);
		}
		...
		protected EObject doDefaultElementCreation() {
			...
			if (newElement != null) {
				newElement
						.setAutoBatchActiviy((EMPAutoBatchActivity) getTarget());
				newElement
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4013Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4013Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4013Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4013Command(CreateRelationshipRequest req) {
			super(req);
		}
	 ...
	 * @generated
	 */
	protected Command getCreateCompleteIncomingEMPAssFlow4026Command(
			CreateRelationshipRequest req) {
		...
		return getMSLWrapper(new CreateIncomingEMPAssFlow4026Command(req) {
	 ...
	 * @generated
	 */
	private static class CreateIncomingEMPAssFlow4026Command extends
			CreateRelationshipCommand {

		/**
		 * @generated
		 */
		public CreateIncomingEMPAssFlow4026Command(CreateRelationshipRequest req) {
			super(req);
		}
