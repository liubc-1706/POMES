...
import newpmbe.process.diagram.edit.policies.EMRRoleItemSemanticEditPolicy;
...
public class EMRRoleEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMORole.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMORole.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMORole.svg";
