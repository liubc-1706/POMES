...
import newpmbe.process.diagram.edit.policies.EMPOutOrItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPOutOrEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMPOutOrEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPOutOrItemSemanticEditPolicy());
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPOutOr.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPOutOr.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPOutOr.svg";
