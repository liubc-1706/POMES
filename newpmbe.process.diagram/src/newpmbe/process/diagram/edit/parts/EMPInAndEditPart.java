...
import newpmbe.process.diagram.edit.policies.EMPInAndItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPInAndEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMPInAndEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPInAndItemSemanticEditPolicy());
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPInAnd.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPInAnd.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPInAnd.svg";
