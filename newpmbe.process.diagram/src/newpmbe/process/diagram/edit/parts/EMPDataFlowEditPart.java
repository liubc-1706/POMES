...
import newpmbe.process.diagram.edit.policies.EMPDataFlowItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPDataFlowEditPart extends ConnectionNodeEditPart {
	 ...
	 * @generated NOT
	 */
	public EMPDataFlowEditPart(View view) {
		super(view);
		//¸øDataFlowÌí¼Ó¼àÌýÆ÷
		//		CompActivityRefresher refresher = CompActivityRefresher.getInstance();
		//		refresher.addNotificationListener(view.getElement());
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPDataFlowItemSemanticEditPolicy());
