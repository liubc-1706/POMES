...
import newpmbe.process.diagram.edit.policies.EMRToolTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRToolTypeEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMRToolType.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMRToolType.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMRToolType.svg";
