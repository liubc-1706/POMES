...
import newpmbe.process.diagram.edit.policies.EMPOtherItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPOtherEditPart extends ShapeNodeEditPart implements Editable{
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPOther.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPOther.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPOther.svg";
