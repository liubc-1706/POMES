...
import newpmbe.process.diagram.edit.policies.EMPMessageItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPMessageEditPart extends ShapeNodeEditPart implements Editable{
	 ...
	 * @generated
	 */
	public EMPMessageEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPMessageItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPMessageEditPart.this.isExternalLabel(editPart);
			}
		};
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPMessage.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPMessage.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPMessage.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPMessageNameEditPart) {
			return true;
		}
		return false;
	}
