...
import newpmbe.process.diagram.edit.policies.EMRLocationTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRLocationTypeEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMRLocationType.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMRLocationType.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMRLocationType.svg";
