...
import newpmbe.process.diagram.edit.policies.EMPOutAndItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPOutAndEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMPOutAndEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPOutAndItemSemanticEditPolicy());
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPOutAnd.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPOutAnd.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPOutAnd.svg";
