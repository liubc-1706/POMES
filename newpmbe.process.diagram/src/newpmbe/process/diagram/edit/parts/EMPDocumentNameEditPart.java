 ...
 * @generated
 */
public class EMPDocumentNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPDocumentNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPDocumentNameEditPart(View view) {
		super(view);
	}
