...
import newpmbe.process.diagram.edit.policies.EMPArtifactItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPArtifactEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMPArtifactEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPArtifactItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPArtifactEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPArtifact.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPArtifact.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPArtifact.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPArtifactNameEditPart) {
			return true;
		}
		return false;
	}
