...
import newpmbe.process.diagram.edit.policies.EMPFormItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPFormEditPart extends ShapeNodeEditPart  implements Editable{
	 ...
	 * @generated
	 */
	public EMPFormEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPFormItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPFormEditPart.this.isExternalLabel(editPart);
			}
		};
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPForm.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPForm.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPForm.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPFormNameEditPart) {
			return true;
		}
		return false;
	}
