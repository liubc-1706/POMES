...
import newpmbe.process.diagram.edit.policies.EMRMachineTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMRMachineTypeEditPart extends ShapeNodeEditPart {
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMRMachineType.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMRMachineType.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMRMachineType.svg";
