 ...
 * @generated
 */
public class EMPOtherNameEditPart extends NewPMBEExtNodeLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPOtherNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPOtherNameEditPart(View view) {
		super(view);
	}
