...
import newpmbe.process.diagram.edit.policies.EMPAutoActivityItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPAutoActivityEditPart extends ShapeNodeEditPart implements Editable {
	 ...
	 * @generated
	 */
	public EMPAutoActivityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPAutoActivityItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPAutoActivityEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		//		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
		//				.DPtoLP(70), getMapMode().DPtoLP(50));
		//		return result;
		try {
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPAutoActivity.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPAutoActivity.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPAutoActivity.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPAutoActivityNameEditPart) {
			return true;
		}
		return false;
	}
