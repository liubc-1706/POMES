 ...
 * @generated
 */
public class EMPMessageNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPMessageNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPMessageNameEditPart(View view) {
		super(view);
	}
