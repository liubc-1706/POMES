...
import newpmbe.process.diagram.edit.policies.EMPClockItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPClockEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMPClockEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPClockItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPClockEditPart.this.isExternalLabel(editPart);
			}
		};
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPClock.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPClock.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPClock.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPClockNameEditPart) {
			return true;
		}
		return false;
	}
