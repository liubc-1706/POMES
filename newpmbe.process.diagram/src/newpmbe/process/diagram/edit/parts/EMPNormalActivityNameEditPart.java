 ...
 * @generated
 */
public class EMPNormalActivityNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPNormalActivityNameEditPart.VISUAL_ID), new Point(0,
				0));
	}
	 ...
	 * @generated
	 */
	public EMPNormalActivityNameEditPart(View view) {
		super(view);
	}
