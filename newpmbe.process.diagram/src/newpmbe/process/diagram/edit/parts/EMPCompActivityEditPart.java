...
import newpmbe.process.diagram.edit.policies.EMPCompActivityItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPCompActivityEditPart extends ShapeNodeEditPart implements Editable{
	...
	private View viewToRemoveListener;

	/**
	 * @generated NOT
	 */
	public EMPCompActivityEditPart(View view) {
		super(view);
		CompFileManager manager = CompFileManager.getInstance();
		manager.addNotificationListener(view.getElement());
		viewToRemoveListener = view;
	}
	
	public void deactivate() {
		CompFileManager manager = CompFileManager.getInstance();
		manager.removeNotificationListener(viewToRemoveListener.getElement());
        super.deactivate();
    }
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPCompActivityItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPCompActivityEditPart.this.isExternalLabel(editPart);
			}
		};
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPCompActivity.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPCompActivity.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPCompActivity.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPCompActivityNameEditPart) {
			return true;
		}
		return false;
	}
