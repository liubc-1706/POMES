 ...
 * @generated
 */
public class EMPArtifactNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPArtifactNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPArtifactNameEditPart(View view) {
		super(view);
	}
