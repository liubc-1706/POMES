...
import newpmbe.process.diagram.edit.policies.EMOResourceGroupTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMOResourceGroupTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EMOResourceGroupTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMOResourceGroupTypeItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMOResourceGroupTypeEditPart.this
	...
	protected NodeFigure createNodePlate() {
		...
		if (icons.equals("icons1"))
			iconsPath = "icons/icons1/EMOGroupType.svg";
		if (icons.equals("icons2"))
			iconsPath = "icons/icons2/EMOGroupType.svg";
		if (icons.equals("icons3"))
			iconsPath = "icons/icons3/EMOGroupType.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMOResourceGroupTypeNameEditPart) {
			return true;
		}
		return false;
	}
