...
import newpmbe.process.diagram.edit.policies.EMPProductPackageItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPProductPackageEditPart extends ShapeNodeEditPart implements Editable{
	 ...
	 * @generated
	 */
	public EMPProductPackageEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPProductPackageItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPProductPackageEditPart.this.isExternalLabel(editPart);
			}
		};
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPProductPackage.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPProductPackage.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPProductPackage.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPProductPackageNameEditPart) {
			return true;
		}
		return false;
	}
