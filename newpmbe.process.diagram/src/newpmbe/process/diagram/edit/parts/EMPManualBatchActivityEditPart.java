...
import newpmbe.process.diagram.edit.policies.EMPManualBatchActivityItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPManualBatchActivityEditPart extends ShapeNodeEditPart implements Editable{
	 ...
	 * @generated
	 */
	public EMPManualBatchActivityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EMPManualBatchActivityItemSemanticEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		NewPMBEExtNodeLabelHostLayoutEditPolicy xlep = new NewPMBEExtNodeLabelHostLayoutEditPolicy() {
			...
			protected boolean isExternalLabel(EditPart editPart) {
				return EMPManualBatchActivityEditPart.this
...
//确定图标的路径
		if(icons.equals("icons1"))
			iconsPath = "icons/icons1/EMPManualBatchActivity.svg";
		if(icons.equals("icons2"))
			iconsPath = "icons/icons2/EMPManualBatchActivity.svg";
		if(icons.equals("icons3"))
			iconsPath = "icons/icons3/EMPManualBatchActivity.svg";
	...
	protected boolean isExternalLabel(EditPart childEditPart) {
		if (childEditPart instanceof EMPManualBatchActivityNameEditPart) {
			return true;
		}
		return false;
	}
