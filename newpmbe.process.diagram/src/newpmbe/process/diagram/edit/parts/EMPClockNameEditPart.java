 ...
 * @generated
 */
public class EMPClockNameEditPart extends NewPMBEExtNodeLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPClockNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPClockNameEditPart(View view) {
		super(view);
	}
