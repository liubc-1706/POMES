 ...
 * @generated
 */
public class EMPManualBatchActivityViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = NewPMBEVisualIDRegistry
					.getType(newpmbe.process.diagram.edit.parts.EMPManualBatchActivityEditPart.VISUAL_ID);
