 ...
 * @generated
 */
public class NewPMBEMatchingStrategy implements IEditorMatchingStrategy {
	...
	public boolean matches(IEditorReference editorRef, IEditorInput input) {
		...
		if (input instanceof DiagramEditorInput
				&& editor instanceof NewPMBEDiagramEditor) {
			Diagram editorDiagram = ((NewPMBEDiagramEditor) editor)
					.getDiagram();
