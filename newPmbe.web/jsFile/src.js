...
{ 
  description="<font style=font-size:9pt; font-color: #000000;background-color:#ccff99>" + description
...
function changeProperty(pname, cname)
{
  	parent.propertyFrame.location = pname + "Property.html#" + cname;
}
