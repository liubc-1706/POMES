...
import newpmbe.product.diagram.edit.policies.EMPMessageItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPMessageEditPart extends ShapeNodeEditPart implements EditableProduct{
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMPMessage.svg"),
				null);
