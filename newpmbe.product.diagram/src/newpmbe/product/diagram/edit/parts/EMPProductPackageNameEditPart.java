...
import newpmbe.product.diagram.edit.policies.NewPMBETextSelectionEditPolicy;
 ...
 * @generated
 */
public class EMPProductPackageNameEditPart extends NewPMBEExtNodeLabelEditPart
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPProductPackageNameEditPart.VISUAL_ID), new Point(0,
				0));
	}
	 ...
	 * @generated
	 */
	public EMPProductPackageNameEditPart(View view) {
		super(view);
	}
