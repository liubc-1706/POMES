 ...
 * @generated
 */
public class EMPFormNameEditPart extends NewPMBEExtNodeLabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(NewPMBEVisualIDRegistry
				.getType(EMPFormNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public EMPFormNameEditPart(View view) {
		super(view);
	}
