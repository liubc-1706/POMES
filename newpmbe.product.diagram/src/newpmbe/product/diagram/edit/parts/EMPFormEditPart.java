...
import newpmbe.product.diagram.edit.policies.EMPFormItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPFormEditPart extends ShapeNodeEditPart  implements EditableProduct{
	...
	protected IFigure createNodeShape() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMPForm.svg"),
				null);
