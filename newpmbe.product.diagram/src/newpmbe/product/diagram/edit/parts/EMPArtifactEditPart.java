...
import newpmbe.product.diagram.edit.policies.EMPArtifactItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPArtifactEditPart extends ShapeNodeEditPart implements EditableProduct{
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMPArtifact.svg"),
				null);
