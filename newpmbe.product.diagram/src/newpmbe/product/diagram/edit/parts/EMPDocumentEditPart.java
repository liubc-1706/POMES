...
import newpmbe.product.diagram.edit.policies.EMPDocumentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EMPDocumentEditPart extends ShapeNodeEditPart implements EditableProduct{
	...
	protected NodeFigure createNodePlate() {
		...
		URL presenterURL = FileLocator.find(NewPMBEDiagramEditorPlugin
				.getInstance().getBundle(), new Path("icons/EMPDocument.svg"),
				null);
