 ...
 * @generated
 */
public class NewPMBEInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new NewPMBENewDiagramFileWizard(mySelectedModelFile,
				myPart.getSite().getPage(), mySelection, diagramRoot,
				editingDomain);
		IDialogSettings pluginDialogSettings = NewPMBEDiagramEditorPlugin
		...
		wizard.setWindowTitle("Initialize new " + EMPDiagramEditPart.MODEL_ID
				+ " diagram file");
